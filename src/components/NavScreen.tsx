          ...
          <div ref={el => {if (el) linkOverflowRefs.current[index] = el}}  className="absolute inset-0 bg-[#FFC914]  flex items-center justify-center translate-y-full overflow-hidden whitespace-nowrap">
            ...
            { index === 2 && (
              <div className="flex items-center gap-6 slide-track">
                ...
                <h1 className="uppercase text-8xl font-semibold text-nowrap">Say What Again.</h1>
                <h1 className="uppercase text-8xl font-semibold text-nowrap">Say What Again!!!!.</h1>
                <div className="w-23 h-5 flex items-center justify-center">
                  <img src="/assets/boondocks6.jpg" alt="image"  className="object-cover rounded-2xl w-full"/>
                </div>
                <h1 className="uppercase text-8xl font-semibold text-nowrap">I dear you, i double dear you mdfk.</h1>
                <h1 className="uppercase text-8xl font-semibold text-nowrap">Say what one more time..... what?</h1>
                <div className="w-23 h-5 flex items-center justify-center">
                  <img src="/assets/boondocks4.jpg" alt="image"  className="object-cover rounded-2xl w-full"/>
                </div>
                <h1 className="uppercase text-8xl font-semibold text-nowrap">What??.</h1>
