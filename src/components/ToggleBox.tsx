    ...
    <nav className="absolute top-0 w-full">
        <div className="flex items-center justify-between ">
            <h3 className="text-3xl ml-5 text-white">LAB 01</h3>
              <div className="group relative z-2 bg-white flex flex-col items-center justify-center cursor-pointer w-34 h-30 overflow-hidden" onClick={()=>setIsNavOpen(true)}>
