    ...
    <nav className="absolute top-0 w-full">
        <div className="flex items-center justify-between ">
            <h3 className="text-3xl ml-5 text-white">LAB I</h3>
              <div className="group relative z-2 bg-white flex flex-col items-center justify-center cursor-pointer w-30 h-25 lg:w-40 lg:h-30 overflow-hidden" onClick={()=>setIsNavOpen(true)}>
